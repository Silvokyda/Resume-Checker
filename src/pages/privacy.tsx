  ...
  return (
    <div className="container max-w-screen-md">
      ...
      <p className="mb-6">
        ...
        Below you will find details about our privacy practices:
      </p>
      <ul className="list-disc pl-4">
        <li className="mb-4">
          <p className="font-bold mb-2">
            We do not store resumes or personal information
          </p>
          <p>
        ...
        <li className="mb-4">
          ...
          <p>
            By using the Resume Checker tool, you agree to the terms described in
            this Privacy Policy.
          </p>
        </li>
      </ul>
